...
function placeXOrO(squareNumber) {
    ...
    //The .some() method is used to check each element of the selected 
    //square array to see if it contains the square number clicked on.
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        audio('./media/148093__jcchilds__jordans-snaps-02.wav');
        //This condition checks to see if it is the computers turn.
        if (activePlayer === 'O') {
            //This function disables clicking for the computers turn.
            disableClick();
            //This function waits 1 second before the computer places an
            //image and enables click.
    ...
    function computersTurn() {
        ...
        while (!success) {
            ...
            if (placeXOrO(pickASquare)) {
                ...
                //This changes our boolean and the loop.
                success = true;
            };
        }
    }
...
function checkWinConditions() {
    ...
    // X 6, 4, 2, condition.
    else if (arrayIncludes('6X', '4X', '2X')) { drawWinLine(100, 505, 510, 90) }
    // X 0, 4, 8, condition.
    ...
    // O 6, 4, 2, condition.
    else if (arrayIncludes('6O', '4O', '2O')) { drawWinLine(100, 505, 510, 90) }
    // O 0, 4, 8, condition.
    else if (arrayIncludes('0O', '4O', '8O')) { drawWinLine(100, 100, 520, 520) } 
    //This condition checks for a tie. If none of the above conditions are met and
    //9 squares aer selected the code executes.
    else if (selectedSquares.length >= 9) {
        //This function plays the tie game sound.
        audio('./media/148095__jcchilds__jordans-snaps-05.wav');
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    audio('./media/148092__jcchilds__jordans-snaps-03.wav');
